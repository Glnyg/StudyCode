...
## 先从这里开始
1. [[00-Overview/authority-package|权威设计包索引]]
2. [[00-Overview/如何学习这个项目|如何学习这个项目]]
3. [[00-Overview/术语总索引|术语总索引]]

## 目录导航
- [[00-Overview/README|00-Overview]]：学习路线、工作流、设计冻结、表达方式。
- [[01-Architecture/README|01-Architecture]]：系统总览、服务边界、数据职责、实现风格。
- [[02-Domain/README|02-Domain]]：[[多租户]]、客服域模型、告警旁路、聊天搜索。
- [[03-AI/README|03-AI]]：[[Copilot]]、[[Autopilot]]、[[RAG]]、策略与工具边界。
- [[04-K8s/README|04-K8s]]：[[Kubernetes]] 平台基线与 [[恢复语义]]。
...
- 搜索读侧：[[02-Domain/聊天记录搜索]]
- AI 决策层：[[03-AI/AI 服务设计]]
- 断电恢复：[[04-K8s/断电恢复与自动恢复]]
